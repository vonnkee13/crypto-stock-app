...
incomes = ["Salary","Business Profit","Other Income"]
expenses = ["Rent","Utilities","Groceries","Savings","Other Expenses"]
currency = "PHP"
...
years = sorted([datetime.today().year+1-i for i in range(3)])
