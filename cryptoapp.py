...
keys = ['Bitcoin', 'Ethereum', 'Shiba Inu','Dogecoin','Chainlink','Algorand', 'SLP', 'XRP', 'Axie Infinity','Polygon']
values = ['BTC-USD', 'ETH-USD', 'SHIB-USD','DOGE-USD','LINK-USD','ALGO-USD','SLP-USD', 'XRP-USD', 'AXS-USD','MATIC-USD']
