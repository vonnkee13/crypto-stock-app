...
keys = ['Bitcoin', 'Ethereum', 'Shiba Inu','Dogecoin','Chainlink', 'SLP', 'XRP', 'Axie Infinity','Polygon']
values = ['BTC-USD', 'ETH-USD', 'SHIB-USD','DOGE-USD','LINK-USD','SLP-USD', 'XRP-USD', 'AXS-USD','MATIC-USD']
